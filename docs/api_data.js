define({ "api": [
  ...
  },
  {
    ...
    "url": "/article/hot",
    "title": "查询热点文章",
    "description": "<p>查询热点文章</p>",
    "name": "show_hot_article",
    "group": "Article",
    "parameter": {
      "fields": {
        "Parameter": [
  ...
  },
  {
    ...
    "url": "/book/article",
    "title": "批量增加书与文章的关系",
    "description": "<p>批量增加书与文章的关系</p>",
    "name": "add_bookArticles",
    "group": "Book",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "values",
            "description": "<p>数据，示例：[{bookId: '', articleId: '', sectionTitle: '', chapterId: ''}]</p>"
          }
        ]
      }
    },
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "values",
            "description": "<p>数据，示例：[{id: '', bookId: '', title: ''}, {bookId: '', title: ''}] id为选传</p>"
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "title": "批量删除小节",
    "description": "<p>批量删除小节</p>",
    "name": "delete_book_article",
    "group": "Book",
    "parameter": {
      "fields": {
        "Parameter": [
  ...
  {
    "type": "get",
    "url": "/redundance/book/article",
    "title": "删除小节中冗余数据",
    "description": "<p>删除小节中冗余数据</p>",
    "name": "delete_book_article_redundance",
    "group": "Book",
    "parameter": {
      "fields": {
        "Parameter": [
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "code",
            "description": "<p>错误码 200：成功；301：没有冗余数据</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
  ...
  },
  {
    ...
    "title": "取消收藏",
    "description": "<p>取消收藏的接口，需要有登录权限</p>",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "type",
            "description": "<p>收藏类型0表示文章，1表示书籍（选传，默认0）</p>"
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "url": "/user/collection",
    "title": "获取用户所有收藏列表",
    "description": "<p>获取用户所有收藏列表（需要登录）</p>",
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "code",
            "description": "<p>错误码 200：成功；201：没有数据</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
